...
3. Edit your device yaml-code and replace the template code with the contents in [heatpump.yaml](./heatpump.yaml)
...
### If you already installed an ESP-device and want to upgrade it
This assumes you have provided an OTA key, that the device is connected to WiFi and that the device it in state **online**.
